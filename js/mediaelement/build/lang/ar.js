...
(function (exports) {
	if (exports.ar === undefined) {
		exports.ar = {
			...
			'mejs.unmute': 'تفعيل الصوت',
			'mejs.mute': 'إيقاف الصوت',
			'mejs.volume-slider': 'مستوي',			
			'mejs.video-player': ' تشغيل فيديو',
			'mejs.audio-player': 'تشغيل اوديو',			
			'mejs.captions-subtitles': 'عنوان',
			'mejs.captions-chapters': 'الشطر',
			'mejs.none': 'Aucun',
